...
public class Hateoas {
    ...
    public static final Resource DatabasesResource = new Resource("/db/", "get");
    ...
    public static String formatResponse(String content, HashMap<String, Resource> resources) {
        //System.out.println("in format resource!!!:");
    ...
    public static JsonObject formatResource(Resource resource) {
        ...
        resourceJson.addProperty("href", "http://localhost:8080" + resource.link);
